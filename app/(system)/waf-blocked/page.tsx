...
export default function WafBlockedPage() {
    return (
        <main className="wrap">
            <section className="card" role="status" aria-live="polite">
                ...
                <h1 className="title">Quick Security Check</h1>

                <p className="text">
                    We’re protecting <b>6chatting</b> from unusual traffic. If you’re a real visitor, you can
                    try again in a moment or go back home.
                </p>
                ...
                <div className="note">
                    <div className="noteTitle">If you think this is a mistake</div>
                    <div className="noteText">
                        Please email <b>support@6chatting.com</b> and include any details available (what you were
                        doing, your country, and <b>Ray ID</b> if it is shown on the page).
                    </div>
                </div>
            ...
            {/* Inline CSS so Cloudflare-served error page still looks premium */}
            <style>{`
